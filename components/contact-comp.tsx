...
export function ContactComp() {
    ...
    return (
        <Flex
            ...
            id="contact"
        >
            <Box borderRadius="lg" m={{ base: 10, md: 16, lg: 20 }} w="100%">
                <Box>
                    <Box
                        h={0}
                        w="100%"
                        display="flex"
                        position="relative"
                        bottom={{ base: 98, sm: 98, md: 50, lg: 62, xl: 62, "2xl": 62 }}
                    >
                        <Box ml="auto">
                            <Popover>
                                <PopoverTrigger>
                                    <Button colorScheme="pink" size="sm" rightIcon={<ArrowDownIcon />}>
                                        Demo Mode
                                    </Button>
                                </PopoverTrigger>
                                <PopoverContent>
                                    <PopoverArrow />
                                    <PopoverCloseButton />
                                    <PopoverHeader fontWeight="bold" m="auto">
                                        Disable Form Submission
                                    </PopoverHeader>
                                    <PopoverBody>
                                        <FormControl display="flex" justifyContent="space-between">
                                            <FormLabel htmlFor="email-alerts">Enable Demo Mode</FormLabel>
                                            <Switch
                                                id="email-alerts"
                                                colorScheme="pink"
                                                isChecked={demoMode}
                                                onChange={onChangeDemoMode}
                                            />
                                        </FormControl>
                                        <FormControl display="flex" justifyContent="space-between">
                                            <FormLabel htmlFor="email-alerts">Simulate Submission Error</FormLabel>
                                            <Switch
                                                id="email-alerts"
                                                colorScheme="pink"
                                                isDisabled={!demoMode}
                                                isChecked={simulateError}
                                                onChange={onChangeSimulateError}
                                            />
                                        </FormControl>
                                    </PopoverBody>
                                </PopoverContent>
                                            ...
                                            <InputGroup>
                                                ...
                                                <Input
                                                    ...
                                                    {...register("name", {
                                                        ...
                                                        maxLength: { value: 22, message: "Max length is 22" },
                                                    })}
                                                />
                                            </InputGroup>
                                            <Box h={2} mt={2}>
