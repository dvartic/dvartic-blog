...
The fron-end utilizes several techniques to improve performance. These are some examples:
...
Where appropriate, pages are generated ahead of time for performance.
...
export function middleware(req: NextRequest) {
    ...
    // if (!lng) lng = acceptLanguage.get(req.headers.get("Accept-Language")); // This line is responsible for detecting or not request headers language preference
