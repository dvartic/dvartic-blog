    ...
    function addBlogJsonLd() {
        return {
            __html: `{
                ...
                "keywords": "software development programming web library framework ${frontmatter.tag.forEach(
    ...
    return (
        <>
            <Head>
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={addBlogJsonLd()} key="product-jsonld" />
            </Head>
            <Box className={codeStyleClass}>
                <Post src={src} frontmatter={frontmatter} strippedContent={strippedContent} />
            </Box>
        </>
    );
};
