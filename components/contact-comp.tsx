...
export function ContactComp() {
    ...
    // Clipboard state for emnail button
                ...
                <Box>
                    ...
                    <VStack spacing={{ base: 2, md: 6, lg: 10 }}>
                        ...
                        <Flex
                            ...
                            maxW={{ base: '100%', sm: '500px', md: '600px', lg: '650px', xl: '650px', '2xl': '650px' }}
                        >
                            <Stack
                                align="center"
                                ...
                                gap={7}
                                mr={{ base: 0, sm: 0, md: 5, lg: 5, xl: 5, '2xl': 5 }}
                                mb={{ base: 2, sm: 2, md: 0, lg: 0, xl: 0, '2xl': 0 }}
                                mt={{ base: 2, sm: 2, md: 0, lg: 0, xl: 0, '2xl': 0 }}
                            >
                                <Spacer />
                                <Tooltip
                                    ...
                                    <VStack spacing={5}>
                                        ...
                                        <FormControl isInvalid={'name' in errors}>
                                            ...
                                            <InputGroup>
                                                ...
                                                <Input type="text" placeholder="Your Name" {...register('name', { required: 'Name is required', minLength: { value: 2, message: 'Min length is 2' }, maxLength: { value: 22, message: 'Max length is 22' } })} />
                                            </InputGroup>
                                            <Box h={2} mt={2}>
                                                <FormErrorMessage mt={0} mb={0}>{errors.name?.message}</FormErrorMessage>
                                            </Box>
                                        </FormControl>
                                        ...
                                        <FormControl isInvalid={'email' in errors}>
                                            ...
                                            <InputGroup>
                                                ...
                                                <Input
                                                    ...
                                                    {...register('email', { required: 'Email is required', pattern: { value: /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/, message: 'Please enter a valid email address' } })}
                                                />
                                            </InputGroup>
                                            <Box h={2} mt={2}>
                                                <FormErrorMessage mt={0} mb={0}>{errors.email?.message}</FormErrorMessage>
                                            </Box>
                                        </FormControl>
                                        ...
                                        <FormControl isInvalid={'message' in errors}>
                                            ...
                                            <Textarea
                                                ...
                                                rows={6}
                                                resize="none"
                                                {...register('message', { required: 'Message is required', minLength: { value: 5, message: 'Min length is 5' }, maxLength: { value: 500, message: 'Max length is 500' } })}
                                            />
                                            <Box h={2} mt={2}>
                                                <FormErrorMessage mt={0} mb={0}>{errors.message?.message}</FormErrorMessage>
                                            </Box>
                            ...
                            <Box w={{ base: '0px', sm: '0px', md: '48px', lg: '48px', xl: '48px', '2xl': '48px' }} />
                        </Flex>
                    </VStack>
                </Box>
            </Box>
