...
export function Header({ propWidth, propMaxWidth }: Props) {
    ...
    const isProjectsActive = router.pathname.includes("/projects");
    ...
    const projectsLinkColor = isProjectsActive ? activeRouteColorLink : "inherit";
            ...
            <Box backgroundColor={bg}>
                ...
                >
                    <NextLink href={"/"} passHref scroll={false}>
                        ...
                        >
                            <HStack spacing={3}>
                                ...
                                <Heading as="h1" display="flex" alignItems="center" size="xl">
                                    Dvartic
                                </Heading>
                            </HStack>
                        </Link>
                    ...
                    <Flex
                        ...
                        fontSize={["lg", "lg", "xl"]}
                        fontWeight="bold"
                        display={{ base: "none", sm: "none", md: "flex", lg: "flex", xl: "flex", "2xl": "flex" }}
                    >
