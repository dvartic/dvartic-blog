...
export function BlogPosts({ propWidth, propMaxWidth, propMt, propMb, pageSrc, posts }: Props) {
    ...
    const getHeading = () => pageSrc === 'index' ? <Heading as='h1' size='2xl' textAlign='center'>Latest <NextLink href='/blog' passHref><Link color='blue.600'>Blog</Link></NextLink> Posts</Heading> : <Heading as='h1' size='2xl' textAlign='center'>Posts</Heading>
    const heading = useMemo(() => getHeading(), [pageSrc])
